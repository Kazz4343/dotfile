...
hl.config({
	general = {
		...
		col = {
			active_border = { colors = { "rgba(e06c75aa)", "rgba(e5c07bee)" }, angle = 45 },
...
hl.animation({ leaf = "windowsIn", enabled = true, speed = 1, bezier = "easeInOutCubic", style = "slide" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 1.5, bezier = "easeOutQuint", style = "slide" })
